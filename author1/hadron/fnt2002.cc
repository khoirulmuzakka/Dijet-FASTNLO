...
//
//    code for first RunII CDF publication of the incl jet x-set w/ cone
//               hep-ex/0512020
//      here:  midpoint cone algo R=0.7 (no Rsep)
...
void UserHHC::initfunc(unsigned int)
{
   ...
   //Define binning in pT   - start at pT=61 - total 20 bins
   npt[0]=20;
