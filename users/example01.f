...
c                  definition in the commonblock!!!!!
      double precision xst1001(266,2,4) 
...
c
      call InitPDFset('/h1/h1gen/lhapdf/LHAPDFv4/PDFsets/cteq61.LHgrid')
...
c         4th argument:  array to return results
      call FX9999CC(FILENAME, 1, 1, XST1001)
...
c - book, fill and store histograms - works now! (Sept 15, 2005 MW)
      call FNHIST(HISTOFILE,1)  ! to plot x-sect histos
