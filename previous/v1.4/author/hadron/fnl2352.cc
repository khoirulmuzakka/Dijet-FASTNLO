//
// fastNLO author code for fnl2352:
...
void UserHHC::initfunc(unsigned int)
{
  ...
  // # of bins
  nrap = 7;
  double rapb[8] = { 0.0, 0.3, 0.8, 1.2, 2.1, 2.8, 3.6, 4.4 };
  ...
  double ptb0[17] = { 20., 30., 45., 60., 80., 110., 160., 210., 260., 310.,
  ...
  cout << "    Scenario fnl2352:" << endl;
  cout << "      ATLAS LHC Inclusive Jets Scenario, E_cms = 7 TeV," << endl;
...
#define WRITE(n) table.write(reinterpret_cast<char *>(&n),sizeof(n))
  ...
  table << "d2sigma-jet_dpTd|y|_[pb_GeV]" << endl;
  table << "ATLAS_Collaboration" << endl;
  table << "Inclusive_Jet_pT" << endl;
  table << "anti-kT_R=0.6" << endl;
  table << "ATLAS-CONF-2011-047" << endl;
  ...
  //JetResol1
  double JetResol1 = 0.6; // jet size R
  WRITE(JetResol1);
