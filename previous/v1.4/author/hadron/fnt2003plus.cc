//
// fastNLO author code for fnt2003 - plus version w/ multiple y ranges
//
...
void UserHHC::initfunc(unsigned int)
{
   ...
   pthigh[0][0] = 21;   //  0<|Y|<0.1   --> 527  (bin goes from 527 to 700)
   pthigh[0][1] = 23;
   pthigh[0][2] = 27;
   pthigh[0][3] = 31;
   pthigh[0][4] = 35;
   ...
   pthigh[1][0] = 21;   //  0.1<|Y|<0.7   --> 527  (bin goes from 527 to 700)
   pthigh[1][1] = 23;
   pthigh[1][2] = 27;
   pthigh[1][3] = 31;
   pthigh[1][4] = 35;
   ...
   pthigh[2][0] = 21;   //  0.7<|Y|<1.1   --> 457  (bin goes from 457 to 527)
   pthigh[2][1] = 23;
   pthigh[2][2] = 27;
   pthigh[2][3] = 31;
   pthigh[2][4] = 35;
   ...
   pthigh[3][0] = 21;   //  1.1<|Y|<1.6   --> 344  (bin goes from 344 to 396)
   pthigh[3][1] = 23;
   pthigh[3][2] = 27;
   pthigh[3][3] = 31;
   pthigh[3][4] = 35;
   ...
   pthigh[4][0] = 21;   //  1.6<|Y|<2.1   --> 259  (bin goes from 259 to 298)
   pthigh[4][1] = 23;
   pthigh[4][2] = 27;
   pthigh[4][3] = 31;
   pthigh[4][4] = 35;
   ...
   cout<<"         *** scenario fnt2003plus ***"<<endl;
   cout<<" "<<endl;
