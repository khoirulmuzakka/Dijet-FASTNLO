//
// fastNLO author code for fnl2222amu8:
...
void UserHHC::initfunc(unsigned int)
{
   ...
   murscale[4] = 1.0;  mufscale[4] = 0.5;
   murscale[5] = 1.0;  mufscale[5] = 2.0;
   murscale[6] = 0.5;  mufscale[6] = 1.0;
   murscale[7] = 2.0;  mufscale[7] = 1.0;
   ...
   cout << "    Scenario fnl2222amu8:" << endl;
