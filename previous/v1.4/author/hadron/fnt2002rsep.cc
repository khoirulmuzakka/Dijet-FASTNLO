//
// fastNLO author code for fnt2002 - computation with Rsep=1.3
//                                   nxtot=10 -> faster for CTEQ fit
//
//    Run II first CDF publication of the incl jet x-set w/ cone R=0.7
//                hep-ex/0512020
// 
// last modification
...
void UserHHC::initfunc(unsigned int)
{
   ...
   raphigh[0]=0.1;        // bins are:  0.1 - 0.7
   raphigh[1]=0.7;        // 
   ...
   //Define binning in pt - 20 published bins
   npt[0]=20;
   ...
   ptlow = 61.;          // 61 for CDF Run II cone
