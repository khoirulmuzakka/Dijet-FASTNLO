//
// fastNLO v2 author code for fnl3332y6:
//     CMS LHC Inclusive Jets Scenario, E_cms = 8 TeV
...
void UserHHC::userfunc(const event_hhc& p, const amplitude_hhc& amp)
{
  ...
  // fnl3332: Not required for inclusive jets
...
void UserHHC::inittable(){
  ...
  A2->ScDescript.push_back("CMS-PAS-SMP-12-012");
  ...
  const double dim2bins[ndim2bins+1] = { 3.2, 4.7 };
  
  const int ndim1bins[ndim2bins] = { 9 };
  ...
  const double dim0[10] = {
    27.  ,   35.,   45.,   57.,   72.,   90.,  120.,  150.,  200.,  300. };
  ...
  // fnl3332: divide by bin width in pT and |y|
