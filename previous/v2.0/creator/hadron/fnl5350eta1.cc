//
// fastNLO v2 creator code for fnl5350eta1:
...
void UserHHC::inittable(){
   ...
   //
   //     fnl5350eta1: Divide by bin width in pT (inner dimension)
   //              Do NOT divide by bin width in outer dimension which is jet size R
   //              DO divide by bin width in eta = 2 * 0.4
   //
