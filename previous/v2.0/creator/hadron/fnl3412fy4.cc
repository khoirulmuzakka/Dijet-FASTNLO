//
// fastNLO v2 creator code for fnl3412fy4:
...
void UserHHC::inittable(){
   ...
   const double dim2bins[ndim2bins+1] = { 2.0, 2.5 };

   const int ndim1bins[ndim2bins] = { 38 };
   ...
   const double dim0[39] = {
      ...
      4337., 4509., 4686., 4869., 5058., 5253., 5455., 5663., 5877.
   };
