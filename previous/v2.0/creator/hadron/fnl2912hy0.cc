//
// fastNLO v2 author code for fnl2912hy0:
...
void UserHHC::inittable(){
  ...
  const int ndim1bins[ndim2bins] = { 42 };
  ...
  // fnl2912hy0: divide by bin width in M3J and 2. * |y_max|
