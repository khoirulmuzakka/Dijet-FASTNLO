//
// fastNLO v2 author code for fnl2912by0:
...
void UserHHC::userfunc(const event_hhc& p, const amplitude_hhc& amp)
{
  ...
  if (njet > 2) {
    ...
    if ( m3jmin <= m3j && y3jmax < yjmax && pt3min <= pT3 ) {
...
void UserHHC::inittable(){
  ...
  // fnl2912by0: divide by bin width in M3J and 2. * |y_max|
