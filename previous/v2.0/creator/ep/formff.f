...
************************************************************************
      ...
      mst                       = 0.150d0
                                ...
                                ! Heavy quark masses:
      mch                       = 1.4d0 ! Synchronize with QCDNUM,RT
      mtp                       = 174d0 ! Synchronize with QCDNUM
      mbt                       = 4.75d0 ! Synchronize with QCDNUM,RT


      aq2    =  1.
      bq2    = -4.
      MassH = mch               ! (available: mc, mb)
