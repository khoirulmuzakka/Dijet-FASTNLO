//
// fastNLO author code for fnr0001 - flexible test scenario for RHIC
...
void UserHHC::initfunc(unsigned int)
{
   ...
   unitfactor = 1.0;  // for nb     << used for RHIC
...
#define WRITE(n) table.write(reinterpret_cast<char *>(&n),sizeof(n))
   ...
   table << "for-RHIC-experiments" << endl;
   table << "-" << endl;
   table << "-" << endl;
