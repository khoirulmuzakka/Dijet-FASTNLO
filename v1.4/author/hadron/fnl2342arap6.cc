//
// fastNLO author code for fnl2342arap6:
...
void UserHHC::initfunc(unsigned int)
{
   ...
   double ptb[122] = {10, 11, 12, 13, 14, 15, 16, 17,
		      ...
		      527, 537, 548, 559, 570, 581};
//                    , 592, 603, 615, 626, 638, 650, 662, 674,
...
// 		      1565, 1588, 1611, 1635, 1659, 1684, 1708, 1733, 1758, 1784};
   ...
   cout << "    Scenario fnl2342arap6:" << endl;
