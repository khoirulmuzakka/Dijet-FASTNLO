//
// fastNLO author code for fnl2332c:
...
void UserHHC::initfunc(unsigned int)
{
  ...
  // Arrays for bin boundaries
  double ptb0[44] = { 97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
		      395., 430., 468., 507., 548., 592., 638., 686., 737., 790., 846., 905.,
		      967., 1032., 1101., 1172., 1248., 1327., 1410., 1497., 1588., 1684.,
		      1784., 1890., 2000., 2116., 2238., 2366., 2500., 2800., 3100., 3500. };
  double ptb1[44] = { 97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
		      395., 430., 468., 507., 548., 592., 638., 686., 737., 790., 846., 905.,
		      967., 1032., 1101., 1172., 1248., 1327., 1410., 1497., 1588., 1684.,
		      1784., 1890., 2000., 2116., 2238., 2366., 2500., 2800., 3100., 3500. };
  double ptb2[40] = { 97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
		      395., 430., 468., 507., 548., 592., 638., 686., 737., 790., 846., 905.,
		      967., 1032., 1101., 1172., 1248., 1327., 1410., 1497., 1588., 1684.,
		      1784., 1890., 2000., 2116., 2238., 2366. };
  double ptb3[32] = { 97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
		      395., 430., 468., 507., 548., 592., 638., 686., 737., 790., 846., 905.,
		      967., 1032., 1101., 1172., 1248., 1327., 1410., 1497. };
  double ptb4[25] = { 97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
		      395., 430., 468., 507., 548., 592., 638., 686., 737., 790., 846., 905.,
		      967. };
  double ptb5[18] = { 97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
		      395., 430., 468., 507., 548., 592. };
  for (int j=0; j<npt[0]+1; j++) { 
    pthigh[0][j] = ptb0[j];
  }
  for (int j=0; j<npt[1]+1; j++) { 
    pthigh[1][j] = ptb1[j];
  }
  for (int j=0; j<npt[2]+1; j++) { 
    pthigh[2][j] = ptb2[j];
  }
  for (int j=0; j<npt[3]+1; j++) { 
    pthigh[3][j] = ptb3[j];
  }
  for (int j=0; j<npt[4]+1; j++) { 
    pthigh[4][j] = ptb4[j];
  }
  for (int j=0; j<npt[5]+1; j++) { 
    pthigh[5][j] = ptb5[j];
  }
  // In reference mode: Copy high end of bin boundaries
  if ( iref==1 ) {
