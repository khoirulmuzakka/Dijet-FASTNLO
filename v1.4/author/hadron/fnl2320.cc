//
// fastNLO author code for fnl2320:
//     CMS LHC test scenario, E_cms = 7 TeV
//     for fastjet kT algo with R=0.5 in E-scheme
// 
// last modification
//
...
class UserHHC : public user_hhc
{
 ...
 private:
  ...
  vector< vector<double> > bicef;
   ...
   pdf_cteq6 pdf;  //   pdf
   fj_kt_05 jetclus;   // jet algorithm
...
void UserHHC::initfunc(unsigned int)
{
   ...
   cout << "    Scenario fnl2320:" << endl;
   cout << "      CMS LHC test scenario, E_cms = 7 TeV," << endl;
   cout << "      for fastjet kT algo with R=0.5 in E-scheme" << endl; 
   cout << " " << endl;
...
#define WRITE(n) table.write(reinterpret_cast<char *>(&n),sizeof(n))
  ...
  //iproc
   ...
   //JetResol1
   double JetResol1 = 0.5;  // kT distance D
   WRITE(JetResol1);
