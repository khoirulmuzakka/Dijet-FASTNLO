//
// fastNLO author code for fnl000a - flexible LHC test scenario
...
void UserHHC::initfunc(unsigned int)
{
   ...
   //Set up binning  
   nrap   = 6;                 // No. of bins in rapidity (5 for Olga) 
...
#define WRITE(n) table.write(reinterpret_cast<char *>(&n),sizeof(n))
   ...
   table << "for-LHC-experiments" << endl;
   table << "-" << endl;
   table << "-" << endl;
