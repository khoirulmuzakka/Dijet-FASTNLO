...
c --- 
c --- CONVERT 2003+ TO 2003
c --- 
c --- modified by K. Rabbertz, M. Wobisch for table fix, Les Houches 07
c ---------------------------------------------------------------------
      implicit none
     ...
     +     xsc(9),xsc1(9),xsc2(9)
      ...
      write(*,*) ' '
      write(*,*) ' ***********************************************'
      write(*,*) ' *     Fix table 0007 for precision of table entry'
      write(*,*) ' * '
      write(*,*) ' * K. Rabbertz, M. Wobisch, Les Houches 07'
      write(*,*) ' * '
      write(*,*) ' ***********************************************'
...
c   -----------------------------------
      ...
      do i=1,nrapidity
         do j=1,NPT(i)
            READ(2,*) XLIMIT(i,j)
            write(*,*)"i,j,xlimit",i,j,xlimit(i,j)
         enddo
      enddo
      READ(2,*) i
      if (i.ne.iseparator) goto 999
...
c -------------------------------------------
      ...
      Integer Nrapmin, NPTMIN(20), NBINOFFSET, noff(20)
      include 'convert2003.inc'
