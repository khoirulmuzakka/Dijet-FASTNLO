//
// fastNLO author code for fnt2310:
//     CMS test scenario, E_cms = 1.96 TeV
//     for fastjet kT algo with D=0.6 in E-scheme
//     pt binning acc. to expected resolution
//     For comparison done at Tevatron Run II energies in p\bar{p} collisions
// 
// last modification
//
...
//    pthigh[5][12] =  300.0;
   ...
   cout << "    Scenario fnt2310:" << endl;
   cout << "      CMS test scenario, E_cms = 1.96 TeV," << endl;
