//
// fastNLO author code for fnt2007
//
//    Run II CDF publication of the incl jet x-set w/ cone R=0.7
//                ..... currently preliminary as of April 2006
// 
// last modification
...
void UserHHC::initfunc(unsigned int)
{
   ...
   //Set up binning  
   nrap   = 5;                 // No. of bins in rapidity (5 for Olga) 
   ...
   raphigh[0]=0.0;        // bins are:  0.1 - 0.7
   raphigh[1]=0.1;        // 
   raphigh[2]=0.7;        // 
   raphigh[3]=1.1;        // 
   raphigh[4]=1.6;        // 
   ...
   ptlow = 54.;          // 54 for CDF Run II kT/cone
   ...
   pthigh[0][0] = 54;  //  0<|Y|<0.1   --> 527  (bin goes from 527 to 700)
   pthigh[0][1] = 62 ;
   pthigh[0][2] = 72 ;
   pthigh[0][3] = 83 ;
   pthigh[0][4] = 96;
   ...
   pthigh[1][0] = 54;  //  0.1<|Y|<0.7   --> 527  (bin goes from 527 to 700)
   pthigh[1][1] = 62 ;
   pthigh[1][2] = 72 ;
   pthigh[1][3] = 83 ;
   pthigh[1][4] = 96;
   ...
   pthigh[2][0] = 54;  //  0.7<|Y|<1.1   --> 457  (bin goes from 457 to 527)
   pthigh[2][1] = 62 ;
   pthigh[2][2] = 72 ;
   pthigh[2][3] = 83 ;
   pthigh[2][4] = 96;
   ...
   pthigh[3][0] = 54;  //  1.1<|Y|<1.6   --> 344  (bin goes from 344 to 396)
   pthigh[3][1] = 62 ;
   pthigh[3][2] = 72 ;
   pthigh[3][3] = 83 ;
   pthigh[3][4] = 96;
   ...
   pthigh[4][0] = 54;   //  1.6<|Y|<2.1   --> 259  (bin goes from 259 to 298)
   pthigh[4][1] = 62 ;
   pthigh[4][2] = 72 ;
   pthigh[4][3] = 83 ;
   pthigh[4][4] = 96;
...
#define WRITE(n) table.write(reinterpret_cast<char *>(&n),sizeof(n))
  ...
  //iproc
   ...
   //JetResol1
   double JetResol1 = 0.7;  // cone R
   WRITE(JetResol1);

   //JetResol2
   double JetResol2 = 0.75; // f_overlap (not effective up to NLO)
   WRITE(JetResol2);
