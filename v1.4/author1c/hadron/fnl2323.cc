//
// fastNLO author code for fnl2323:
//     CMS LHC test scenario, E_cms = 7 TeV
//     for fastjet CA algo with R=0.5 in E-scheme
// 
// last modification
//
...
class UserHHC : public user_hhc
{
 ...
 private:
  ...
  vector< vector<double> > bicef;
   ...
   pdf_cteq6 pdf;  //   pdf
   fj_ca_05 jetclus;   // jet algorithm
...
void UserHHC::initfunc(unsigned int)
{
   ...
   //    1101., 1172., 1248., 1327., 1410., 1497., 1588., 1684., 1784.},
   //----- rap bin 1, # = 37
   pthigh[0][0]  =   53.0;
   pthigh[0][1]  =   67.0;
   pthigh[0][2]  =   81.0;
   ...
   cout << "    Scenario fnl2323:" << endl;
   cout << "      CMS LHC test scenario, E_cms = 7 TeV," << endl;
   cout << "      for fastjet CA algo with R=0.5 in E-scheme" << endl; 
   cout << " " << endl;
...
#define WRITE(n) table.write(reinterpret_cast<char *>(&n),sizeof(n))
   ...
   table << "Cambridge-Aachen_R=0.6" << endl;
