...
void UserHHC::initfunc(unsigned int)
{
   ...
   for(int i=0;i<nrap;i++){
     raphigh[i+1]=raphigh[i]+1.0;    // these are dijet rapidity bins
   }
   ...
   // --- info from Ken:
   //180.,198.,217.,241.,265.,292.,321.,353.,388.,427.,
   //  470.,517.,568.,625.,688.,756.,832.,915.,1007.,1108.,
   //  1219.,1341.,1475.
   ...
   cout<<"         *** scenario fnt2008 ***"<<endl;
   cout<<"        (CDF Run II dijets - w/ rsep)"<<endl;
   cout<<"            (prel.)"<<endl;
   cout<<" "<<endl;
