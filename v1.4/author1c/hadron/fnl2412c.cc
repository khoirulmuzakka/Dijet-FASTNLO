//
// fastNLO author code for fnl2412c:
...
void UserHHC::initfunc(unsigned int)
{
   ...
   double ptb0[33] = { 156.0, 176.0, 197.0, 220.0, 244.0, 270.0, 296.0, 325.0, 354.0, 386.0, 
   ...
   double ptb1[32] = { 197.0, 220.0, 244.0, 270.0, 296.0, 325.0, 354.0, 386.0, 419.0, 453.0,
		       ...
		       2659.0, 3019.0 };
   double ptb2[25] = { 386.0, 419.0, 453.0, 489.0, 526.0, 565.0, 606.0, 649.0, 693.0, 740.0,
		       788.0, 838.0, 890.0, 944.0, 1000.0, 1118.0, 1246.0, 1383.0, 1530.0, 1687.0,
		       1856.0, 2037.0, 2332.0, 2659.0, 3019.0 };
   double ptb3[21] = { 565.0, 606.0, 649.0, 693.0, 740.0, 788.0, 838.0, 890.0, 944.0, 1000.0,
		       1118.0, 1246.0, 1383.0, 1530.0, 1687.0, 1856.0, 2037.0, 2332.0, 2659.0, 3019.0,
		       3854.0 };
   double ptb4[19] = { 649.0, 693.0, 740.0, 788.0, 838.0, 890.0, 944.0, 1000.0, 1118.0, 1246.0,
   ...
   cout << "    Scenario fnl2412c:" << endl;
   cout << "      CMS LHC Dijet Mass Scenario, E_cms = 7 TeV,"  <<  endl;
...
// Initialize pointers to the jets, check minimal jet pT and maximal |y,eta|
   ...
   if (njet >= 2) {
     ...
     if ( mjj > pthigh[0][0] && ptmax > pt1low ) {
       ...
       // KR: Note, for more than one (pseudo-)rapidity bin the larger |y,eta|
       //     of the two jets determines the y bin
	 ...
	 if (raphigh[j] <= yjjmax && yjjmax < raphigh[j+1]) {
	   rapbin=j;
