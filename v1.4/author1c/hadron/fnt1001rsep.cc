//
// fastNLO author code for fnt1001 for midpoint ago - with Rsep=1.3
...
void UserHHC::initfunc(unsigned int)
{
   ...
   //Set up binning  
   nrap   = 1;                 // No. of bins in rapidity (5 for D0) 
   ...
   //----- array for pt boundaries
   pthigh[0][0] =  40.5;        // CDF bins derived from published CDF ansatz
   pthigh[0][1] =  46.5;
   pthigh[0][2] =  52.44;
   pthigh[0][3] =  58.26;
   pthigh[0][4] =  64.01;
