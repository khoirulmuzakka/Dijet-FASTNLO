...
*******************************************************************
      SUBROUTINE FT2010CC(FILENAME, XMUR, XMUF, IPRINTFLAG, XSECT)
*-----------------------------------------------------------------
...
c - now get the PDFs ...
      call FT2010GP(mufscale(ixmuf))
c - ... and multiply with perturbative coefficients 
      call FT2010MT(xmur,ixmuf)
...
c - print results - if requested
      if (IPRINTFLAG.eq.1) call FT2010PR(xmur,IXMUF)
...
*******************************************************************
      SUBROUTINE FT2010MT(xmur,ixmuf)
*-----------------------------------------------------------------
* MW 08/26/2005
*
...
c - now fill main PDF array - compute different lin. comb for diff sub-proc
               ...
               do k=1,NXTOT
                  ...
                  do l=1,nx2limit
                     nx=nx+1
                     call ft2010pl(ireaction,k,l,XPDF,H)
                     do m=1,Nsubproc
                        pdf(nbin,nx,m,p) = H(m)
                     enddo
                  enddo
...
*******************************************************************
      SUBROUTINE FT2010PL(ireact,i,j,XPDF,H)
* ---------------------------------------------------------------
* MW 03/27/06
...
*******************************************************************
      ...
      SUBROUTINE FT2010PR(XMUR,IMUFFLAG)
*-----------------------------------------------------------------
