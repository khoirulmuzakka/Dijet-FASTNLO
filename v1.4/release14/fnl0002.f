...
*******************************************************************
      SUBROUTINE FL0002CC(FILENAME, XMUR, XMUF, IPRINTFLAG, XSECT)
*-----------------------------------------------------------------
...
c - now get the PDFs ...
      call FL0002GP(mufscale(ixmuf))
c - ... and multiply with perturbative coefficients 
      call FL0002MT(xmur,ixmuf)
...
c - print results - if requested
      if (IPRINTFLAG.eq.1) call FL0002PR(xmur,IXMUF)
...
*******************************************************************
      SUBROUTINE FL0002MT(xmur,ixmuf)
*-----------------------------------------------------------------
* MW 08/26/2005
*
...
*******************************************************************
      SUBROUTINE FL0002PL(ireact,i,j,XPDF,H)
* ---------------------------------------------------------------
* MW 03/27/06
...
*******************************************************************
      ...
      SUBROUTINE FL0002PR(XMUR,IMUFFLAG)
*-----------------------------------------------------------------
