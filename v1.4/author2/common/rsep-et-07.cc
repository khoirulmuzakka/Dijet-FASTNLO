...
rsep_et_07::operator()(const event_hhc& ev, double rcone)
{
  ...
  for(int i = 1; i <= np; i++) {
    for(int j = i + 1; j <= np; j++) {     
      if(merge == 0 && (dist = _M_pair(i,j)) < rcone) {
	_M_merge_Et(i, j);               //   i<j
	merge = 1;
	nj--;
...
double rsep_et_07::_M_pair(int i, int j)
{
  static const double pi = 3.14159265358979323846;
  static const double twopi = 6.28318530717958647692;
  static const double rsep = 1.3;
...
void rsep_et_07::_M_merge_Et(int i, int j)
{
  static const double pi = 3.14159265358979323846;
  static const double twopi = 6.28318530717958647692;
