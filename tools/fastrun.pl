...
if ( $opt_h ) {
    ...
    print "  -f rev|vers     fastNLO revision (v1.4, e.g.=542) or\n";
    print "                  fastNLO version to use (v2, def.=2.0.0)\n";
...
# 2003 seems to work on SuSE 11.0 & Mandriva 10
    ...
    $install{root}[1]       = "root";
    $install{fastjet}[0]    = "fastjet-2.4.2";
    $install{fastjet}[1]    = "fastjet-2.4.2";
