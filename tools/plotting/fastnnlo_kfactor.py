...
def main():
    ...
    orders = {'LO': [True, False, False], 'NLO': [
        True, True, False], 'NNLO': [True, True, True]}
    ...
    if (allplots == False):
        if high == 'NLO':
            ...
            sys.exit(
                'ERROR: NNLO chosen although table does not contain NNLO entry. Aborted!')
    ...
    ax0.text(0.96, 0.03, args['pdfset'], alpha=0.6, transform=ax0.transAxes,
