...
titwgt = 'bold'
limfs = 'x-large'
sclnam = [r'$\bf p_T$', r'$\bf\mu_r = \mu_f$ small', r'$\bf\mu_r = \mu_f$ large', r'$\bf\mu_r < \mu_f$', r'$\bf\mu_r > \mu_f$', r'$\bf\mu_r \ll \mu_f$', r'$\bf\mu_r \gg \mu_f$']
col1  = 'olivedrab'
col1b = 'yellowgreen'
col2 = 'orangered'
col3 = 'dodgerblue'
...
#        axhandles.append(abs1n)
    ...
    if xaxe=='bins':
        ...
        if args['outputfilename'] is None:
            ...
            fignam = args['outputfilename']+'.scale-no-'+str(i+1)+'.absolute-obs'+'.png'
