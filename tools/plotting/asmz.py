...
ax.set_xticks([0.108,0.112,0.114,0.116,0.118,0.122,0.124,0.126,0.128], minor=True)
...
ax.set_xlabel('%s' %_asmz_label, horizontalalignment='right', x=1.0, verticalalignment='top', y=1.0, fontsize='xx-large')
