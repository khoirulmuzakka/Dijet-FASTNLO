...
_text_dlim = 0.0810
_asmz_ulim = 0.1300
_asmz = [0.1181, 0.1135, 0.1144, 0.1139, 0.1151,
         0.1196, 0.1162, 0.1195, 0.1173,
         0.1150, 0.1148, 0.1171, 0.1199, 0.1185, 0.1164, 0.1192, 0.1185]
_ypos = [1, 3, 4, 5, 6, 8, 9, 10, 11, 13, 14, 15, 17, 19, 20, 21, 22]
_dasmz_oth_up = [0, 18, 25, 23, 27,
                 22, 21, 24, 20,
                 22, 23, 28, 15, 19, 29, 23, 35]
_dasmz_oth_dn = [0, 17, 25, 23, 26,
                 22, 21, 24, 20,
                 22, 23, 28, 16, 26, 33, 19, 35]
_dasmz_scl_up = [11, 11, 16, 14, 9,
                 61, 76, 60, 63,
                 50, 50, 69, 31, 22, 53, 24, 53]
_dasmz_scl_dn = [11, 5, 20, 1, 8,
                 13, 61, 15, 20,
                 0, 50, 40, 19, 18, 28, 39, 24]
...
ax.set_title('%s results from LHC' % _asmz_label, fontsize='xx-large')
...
ax.text(_text_dlim, 23, 'Inclusive jets, NLO',
...
ax.text(_text_dlim, 12, r'EEC, NLO',
        fontsize='large', fontweight='bold', va='center')
ax.text(_text_dlim,
        _ypos[-9], r'7 TeV, TEEC, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$', fontsize='large', va='center')
ax.text(_text_dlim,
        _ypos[-10], r'8 TeV, TEEC, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$', fontsize='large', va='center')
ax.text(_text_dlim,
        _ypos[-11], r'7 TeV, ATEEC, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$', fontsize='large', va='center')
ax.text(_text_dlim,
        _ypos[-12], r'8 TeV, ATEEC, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$', fontsize='large', va='center')
ax.text(_text_dlim,  7, r'top-antitop',
        fontsize='large', fontweight='bold', va='center')
ax.text(_text_dlim,
        _ypos[-13], r'7 TeV, $\sigma_\mathrm{tot}$, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$, NNLO+NNLL', fontsize='large', va='center')
ax.text(_text_dlim,
        _ypos[-14], r'13 TeV, $\sigma_\mathrm{tot}$, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$, NNLO', fontsize='large', va='center')
ax.text(_text_dlim,
        _ypos[-15], r'13 TeV, $\sigma_\mathrm{diff}$, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$, NLO, prel.', fontsize='large', va='center')
ax.text(_text_dlim,
        _ypos[-16], r'13 TeV, $\sigma_\mathrm{diff}$, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$+PDF, NLO, prel.', fontsize='large', va='center')
