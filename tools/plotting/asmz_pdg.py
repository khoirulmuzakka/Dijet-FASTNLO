...
###########################################
#
# Plot alpha_s(M_Z) values for PDG comparison
#
#
...
_text_dlim = 0.0810
_asmz_ulim = 0.1300
_asmz         = [0.1181, 0.1135, 0.1144, 0.1139, 0.1151, 0.1150, 0.1148, 0.1171, 0.1199, 0.1185, 0.1164, 0.1192, 0.1185]
...
#ax.grid(False)
ax0.grid(b=True, which='major', linestyle='-')
ax0.grid(b=True, which='minor', linestyle=':')
ax0.set_yticks([])
ax0.set_xticks([0.110,0.120,0.130])
ax0.set_xticks([0.108,0.112,0.114,0.116,0.118,0.122,0.124,0.126,0.128], minor=True)
ax0.tick_params(direction='in', which='both', labelsize='x-large')
ax0.tick_params(axis='x', which='minor', length=4)
ax0.tick_params(axis='x', which='major', length=8)
ax0.set_title(r'Summary of %s' %_asmz_label, fontsize='xx-large')
ax0.set_xlim([_asmz_dlim, _asmz_ulim])
ax0.set_ylim([0,_ypos[-1]+2])
ax0.set_xlabel('%s' %_asmz_label, horizontalalignment='right', x=1.0, verticalalignment='top', y=1.0, fontsize='xx-large')
#xfmt = ScalarFormatterForceFormat()
#xfmt.set_powerlimits((0,0))
#ax.xaxis.set_major_formatter(xfmt)

#_ypos = np.array(_ypos)-0.5
ax0.text(_text_dlim, 18, 'Inclusive jets, NLO', fontsize='large', fontweight='bold', va='center')
ax0.text(_text_dlim, _ypos[-1], r'7 TeV, $p_\mathrm{T}$, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$', fontsize='large', va='center')
ax0.text(_text_dlim, _ypos[-2], r'7 TeV, $p_\mathrm{T}$, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$+PDF', fontsize='large', va='center')
ax0.text(_text_dlim, _ypos[-3], r'8 TeV, $p_\mathrm{T}$, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$', fontsize='large', va='center')
ax0.text(_text_dlim, _ypos[-4], r'8 TeV, $p_\mathrm{T}$, $\alpha_\mathrm{s}(\mathrm{M}_\mathrm{Z})$+PDF', fontsize='large', va='center')
...
area = patches.Rectangle((0.111,2.5), 0.007, 4.0, color='gold', alpha=0.3)
ax0.add_patch(area)
ax0.errorbar(_asmz, _ypos, xerr=xerr_oth, marker='o', markersize=8, elinewidth=2, capsize=0, capthick=2, color='red', mec='red', linestyle='none')
ax0.errorbar(_asmz, _ypos, xerr=xerr_tot, marker='', markersize=8, elinewidth=2, capsize=4, capthick=2, color='red', linestyle='none')
ax0.axvspan(_asmz[0]-xerr_tot[0,0], _asmz[0]+xerr_tot[1,0], color='grey', alpha=0.5)
