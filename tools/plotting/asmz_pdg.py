...
ax0.set_xticks([0.108, 0.112, 0.114, 0.116, 0.118,
...
ax0.set_xlabel('%s' % _asmz_label, horizontalalignment='right',
...
ax0.text(_text_dlim, 18, 'Inclusive jets, NLO',
...
ax0.add_patch(area)
ax0.errorbar(_asmz, _ypos, xerr=xerr_oth, marker='o', markersize=8, elinewidth=2,
             capsize=0, capthick=2, color='red', mec='red', linestyle='none')
ax0.errorbar(_asmz, _ypos, xerr=xerr_tot, marker='', markersize=8,
             elinewidth=2, capsize=4, capthick=2, color='red', linestyle='none')
ax0.axvspan(_asmz[0]-xerr_tot[0, 0], _asmz[0] +
            xerr_tot[1, 0], color='grey', alpha=0.5)
