...
%% KR Don´t know/have this one. TBD
%% lisings package for c++ code syntax highlighting
%%\input{listingsinclude2.tex}
...
%\lstinputlisting[label=yourLabel,caption=Your caption]{
%%sourceCode/yourcode.c}
