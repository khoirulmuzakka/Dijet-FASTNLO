//
// fastNLO v2 creator code for fnl2380ak0507y4:
...
void UserHHC::userfunc(const event_hhc& p, const amplitude_hhc& amp)
{
   ...
   const unsigned int ndim1bins = 21;
...
void UserHHC::inittable(){
   ...
   A1->SetScenName("fnl2380ak0507y4");
   ...
   const int ndim1bins[ndim2bins] = { 21, 21 };
