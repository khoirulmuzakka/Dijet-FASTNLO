//
// fastNLO v2 creator code for fnl3412fy3:
...
void UserHHC::inittable(){
   ...
   const double dim2bins[ndim2bins+1] = { 1.5, 2.0 };
   ...
   const double dim0[49] = {
      649. ,  693.,  740.,  788.,  838.,  890.,  944., 1000., 1058., 1118.,
      ...
      4509., 4686., 4869., 5058., 5253., 5455., 5663., 5877., 6099.
   };
