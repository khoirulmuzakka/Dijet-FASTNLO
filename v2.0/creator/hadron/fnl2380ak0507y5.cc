//
// fastNLO v2 creator code for fnl2380ak0507y5:
...
void UserHHC::userfunc(const event_hhc& p, const amplitude_hhc& amp)
{
   ...
   const unsigned int ndim1bins = 15;
...
void UserHHC::inittable(){
   ...
   A1->SetScenName("fnl2380ak0507y5");
   ...
   const int ndim1bins[ndim2bins] = { 15, 15 };
   ...
   const double dim0[16] = {
      56.  ,   64.,   74.,   84.,   97., 114. ,  133.,  153.,  174.,  196.,
      220. ,  245.,  272.,  300.,  330., 362. };
   for (int i=0; i<ndim2bins; i++) {
   ...
   //
   //     fnl2380: Divide by bin width in pT (1st dimension)
