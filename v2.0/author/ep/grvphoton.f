...
C...X * U = X * UBAR :
       ...
       E  =  4.899 + 1.678 * S
       ES =  2.046 + 1.389 * S
       UL =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * D = X * DBAR :
       AL =  1.549
       BE =  0.782
       AK =  0.496 + 0.026 * S
       ...
       E  =  4.807 + 1.226 * S
       ES =  2.166 + 0.664 * S
       DL  =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * G :
       AL =  0.676
       BE =  1.089
       AK =  0.462 - 0.524 * SS
       ...
       E  =  0.893 + 1.968 * S
       ES =  3.432 + 0.392 * S
       GL =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * S = X * SBAR :
       SF =   0.0
       AL =  1.609
       BE =  0.962
...
C...X * U = X * UBAR :
       ...
       E  =  4.147 + 1.131 * S
       ES =  1.661 + 0.874 * S
       UH =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * D = X * DBAR :
       AL =  0.591
       BE =  0.698
       ...
       E  =  4.202 + 1.352 * S
       ES =  1.841 + 0.990 * S
       DH  =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * G :
       AL =  1.161
       BE =  1.591
       ...
       E  =   0.0  + 2.704 * S
       ES =  3.071 - 0.378 * S
       GH =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * S = X * SBAR :
       SF =   0.0
       AL =  0.635
       BE =  0.456
...
C...X * U = X * UBAR :
       ...
       E  =  4.225 + 1.708 * S
       ES =  1.752 + 0.866 * S
       U0 =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * D = X * DBAR :
       AL =  1.424
       BE =  0.770
       ...
       E  =  4.346 + 1.638 * S
       ES =  1.645 + 1.016 * S
       D0  =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * G :
       AL =  0.661
       BE =  0.793
       AK =  0.537 - 0.600 * SS
       ...
       E  =  1.429 + 1.772 * S
       ES =  3.331 + 0.806 * S
       G0 =  F (X, S, AL, BE, AK, BK, AG, BG, C, D, E, ES)
C...X * S = X * SBAR :
       SF =   0.0
       AL =  1.578
       BE =  0.863
