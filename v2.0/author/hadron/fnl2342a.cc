...
void UserHHC::inittable(){
  ...
  // KR: For testing only central rapidity bin
  // const int nrapbins = 6;
  // double rapbins[nrapbins+1] = {0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0};
  const int nrapbins = 1;
  double rapbins[nrapbins+1] = {0.0, 0.5};
  
  // const int nptbins[nrapbins] = {49, 49, 49, 46, 39, 32};
  const int nptbins[nrapbins] = {49};
  double ptbins[1][50] = {{ 10., 12., 15., 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84., 97.,
			    114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362., 395., 430., 468.,
			    507., 548., 592., 638., 686., 737., 790., 846., 905., 967.,
			    1032., 1101., 1172., 1248., 1327., 1410., 1497., 1588., 1684., 1784.}};
  // double ptbins[2][50] = {{ 10., 12., 15., 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84., 97.,
  // 			    114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362., 395., 430., 468.,
  // 			    507., 548., 592., 638., 686., 737., 790., 846., 905., 967.,
  // 			    1032., 1101., 1172., 1248., 1327., 1410., 1497., 1588., 1684., 1784.}};
  // double ptbins[3][50] = {{ 10., 12., 15., 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84., 97.,
  // 			    114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362., 395., 430., 468.,
  // 			    507., 548., 592., 638., 686., 737., 790., 846., 905., 967.,
  // 			    1032., 1101., 1172., 1248., 1327., 1410., 1497., 1588., 1684., 1784.}};
  // double ptbins[4][47] = {{ 10., 12., 15., 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84., 97.,
  // 			    114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362., 395., 430., 468.,
  // 			    507., 548., 592., 638., 686., 737., 790., 846., 905., 967.,
  // 			    1032., 1101., 1172., 1248., 1327., 1410., 1497.}};
  // double ptbins[5][40] = {{ 10., 12., 15., 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84., 97.,
  // 			    114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362., 395., 430., 468.,
  // 			    507., 548., 592., 638., 686., 737., 790., 846., 905., 967.}};
  // double ptbins[6][33] = {{ 10., 12., 15., 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84., 97.,
  // 			    114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362., 395., 430., 468.,
  // 			    507., 548., 592.}};
