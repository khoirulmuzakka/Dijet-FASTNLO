...
void UserHHC::inittable(){
  ...
  double ptbins[1][35] = {{ 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84.,
			    97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
			    395., 430., 468., 507., 548., 592., 638., 686., 737., 846., 1684. }};
  double ptbins[2][34] = {{ 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84.,
			    97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
			    395., 430., 468., 507., 548., 592., 638., 686., 790., 1684. }};
  double ptbins[3][33] = {{ 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84.,
			    97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
			    395., 430., 468., 507., 548., 592., 638., 686., 1410. }};
  double ptbins[4][30] = {{ 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84.,
			    97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
			    395., 430., 468., 507., 548., 1032. }};
  double ptbins[5][27] = {{ 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84.,
			    97., 114., 133., 153., 174., 196., 220., 245., 272., 300., 330., 362.,
			    395., 430., 737. }};
  double ptbins[6][23] = {{ 18., 21., 24., 28., 32., 37., 43., 49., 56., 64., 74., 84.,
